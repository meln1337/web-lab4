    ...
    return (
        <div className="container">
            ...
            <form>
                ...
                <div className="form-group">
                    <label>Text</label>
                    <textarea alt="text" onChange={onInput} className="textarea" rows="9" />
                </div>
                <div className="form-group">
                    <label>Place id</label>
                    <input value={form.place_id} alt="place_id" onInput={onInput} type="number" className="input sign-up-place-id" placeholder="Place id" />
                </div>
                <button onClick={add_ad} type="reset" className="btn submit">Submit</button>
